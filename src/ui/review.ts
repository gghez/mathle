...
/**
 * Render the end-of-game answer review: every graded question always shows both
 * the answer the player gave and the correct one, whether right or wrong. Reuses
 * the rules screen's scrolling shell.
 */
